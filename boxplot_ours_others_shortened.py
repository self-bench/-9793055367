...
df_color_attributes_ours = pd.DataFrame({
...
df_counting_ours = pd.DataFrame({
    ...
    # 'EqBench': eq_kubric_counting_scores,
    # 'MMVP': quantity_scores_mmvp_vlm,
    'SD 1.5': counting_correct_scores_first_block,
    'SD 2.0': counting_correct_scores_second_block,
    'SD 3-m': counting_correct_scores_third_block
})
...
df_object_ours = pd.DataFrame({
    "SD 1.5": single_object_correct_first_block,
    "SD 2.0": single_object_correct_second_block,
    "SD 3-m": single_object_correct_third_block,
})
...
df_spatial_ours = pd.DataFrame({
    ...
    'SD 1.5': position_correct_scores_first_block,
    'SD 2.0': position_correct_scores_second_block,
    'SD 3-m': position_correct_scores_third_block,

})

df_two = pd.DataFrame({
'SD 1.5': two_objects_correct_first_block,
    'SD 2.0': two_objects_correct_second_block,
    'SD 3-m': two_objects_correct_third_block,
})

df_attribute_ours_first = pd.DataFrame({
    "Colors": color_correct_scores_first_block,
    "Color_Attribution": color_attribute_scores_first_block,
})

df_attribute_ours_first = df_attribute_ours_first.mean(axis=1)
df_attribute_ours_first = pd.DataFrame({"SD 1.5": df_attribute_ours_first})

df_attribute_ours_second = pd.DataFrame({
    "Colors": color_correct_scores_second_block,
    "Color_Attribution": color_attribute_scores_second_block,
})

df_attribute_ours_second = df_attribute_ours_second.mean(axis=1)
df_attribute_ours_second = pd.DataFrame({"SD 2.0": df_attribute_ours_second})

df_attribute_ours_third = pd.DataFrame({
    "Colors": color_correct_scores_third_block,
    "Color_Attribution": color_attribute_scores_third_block,
})

df_attribute_ours_third  = df_attribute_ours_third.mean(axis=1)
df_attribute_ours_third = pd.DataFrame({"SD 3-m": df_attribute_ours_third})

df_attribute_ours = pd.concat([df_attribute_ours_first, df_attribute_ours_second, df_attribute_ours_third], axis=1)

df_object_ours_first = pd.DataFrame({
    "Single Object": single_object_correct_first_block,
    "Two Objects": two_objects_correct_first_block,
})

df_object_ours_first = df_object_ours_first.mean(axis=1)
df_object_ours_first = pd.DataFrame({"SD 1.5": df_object_ours_first})

df_object_ours_second = pd.DataFrame({
    "Single Object": single_object_correct_second_block,
    "Two Objects": two_objects_correct_second_block,
})

df_object_ours_second = df_object_ours_second.mean(axis=1)
df_object_ours_second = pd.DataFrame({"SD 2.0": df_object_ours_second})

df_object_ours_third = pd.DataFrame({
    "Single Object": single_object_correct_third_block,
    "Two Objects": two_objects_correct_third_block,
})

df_object_ours_third = df_object_ours_third.mean(axis=1)
df_object_ours_third = pd.DataFrame({"SD 3-m": df_object_ours_third})

df_object_ours = pd.concat([df_object_ours_first, df_object_ours_second, df_object_ours_third], axis=1)
...
def create_bar_plot(df, category_name):
    df_transposed = df.T
    # not generation collum
    df_transposed = df_transposed.drop(columns=['Generation'])
    # Color schemes
...
# create_bar_plot(df_attribute_ours, "Color_attr")
create_bar_plot(df_attribute_ours, "Color_attr_ours")
create_bar_plot(df_counting, "Counting_ours")
create_bar_plot(df_object_ours, "Object_ours")
create_bar_plot(df_spatial, "Spatial_ours")
