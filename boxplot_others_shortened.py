...
def create_bar_plot(df, category_name):
    ...
    #     fig, ax = plt.subplots(figsize=(25, 5)) # 30:1,
    ...
    # elif  category_name == "Attributes" or category_name == "Complex":
    #     print("Spatial or Attributes")
    #     fig, ax = plt.subplots(figsize=(20, 5)) # 30:1,
    #     leftmost = index[0] - bar_width -0.2  # Or maybe 0 - bar_width
    #     rightmost = index[-1] + len(df_transposed.columns)*bar_width +0.2
    ...
    #     fig, ax = plt.subplots(figsize=(10, 5))
    # else:
    #     fig, ax = plt.subplots(figsize=(15*8/11, 5))
    # 
    # 6:5
    # 8 ?
    ...
    eqbench_positions = [(index[i], label) for i, label in enumerate(df_transposed.index) if 'EQBench' in label or 'EqBench' in label]
    ...
    if category_name == "Spatial" or category_name == "Action" or category_name == "Attributes":
...
# create_bar_plot(df_attribute_ours, "ours_Attributes")
# create_bar_plot(df_counting_ours, "ours_Counting")
# create_bar_plot(df_object_ours, "ours_Object")
# create_bar_plot(df_spatial_ours, "ours_Spatial")
