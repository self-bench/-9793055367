...
class Controlled_Images(Dataset):
    def __init__(self, image_preprocess, text_perturb_fn=None, image_perturb_fn=None, root_dir=ARO_ROOT, download=False, subset='A', resize=512):
        self.root_dir = root_dir
        if subset == 'A':
    ...
    def __getitem__(self, index):
        ...
        return [image_path, [img0_resize]], test_case["caption_options"], 0
        # return [[img], [img0_resize]], test_case["caption_options"], 0
...
class COCO_QA(Dataset):
    def __init__(self, image_preprocess, text_perturb_fn=None, image_perturb_fn=None, root_dir=ARO_ROOT, download=False, subset='one',resize=512):
        self.root_dir = root_dir
        if subset == 'one':
