...
try:
    ...
    _import_structure["pipelines"].extend(
        [
            ...
            "StableDiffusion3Img2ImgPipelineReal",
            ...
            "StableDiffusionImg2ImgPipeline_test",
            "StableDiffusionImg2ImgPipelineORG",
...
# print(_import_structure["pipelines"]) # loaded well
# exit(0)
