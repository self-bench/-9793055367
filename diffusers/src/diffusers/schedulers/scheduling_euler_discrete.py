...
class EulerDiscreteScheduler(SchedulerMixin, ConfigMixin):
    ...
    def scale_model_input(self, sample: torch.Tensor, timestep: Union[float, torch.Tensor], itm = False) -> torch.Tensor:
        """
        ...
        """
        if itm:
            # print(self.begin_index) # none
            # exit(0)
            self._init_step_index(timestep)
        else:
            if self.step_index is None: # no.
                self._init_step_index(timestep)
        # self.step_index is different
    ...
    def index_for_timestep(self, timestep, schedule_timesteps=None):
        ...
        # print(schedule_timesteps.shape) #1000
        # print(timestep.shape) #16, 128, 128  # it should be none but we have it
        # exit(0)
    ...
    def _init_step_index(self, timestep):
        if self.begin_index is None:
            # print("begin_index is None") # keep being here
            # exit(0)
    ...
    def add_noise(
        ...
        if self.begin_index is None:
            # print("here") # keep being here
            # exit(0)
            # print(timesteps.shape)
            # print(schedule_timesteps.shape)
            # exit(0)
