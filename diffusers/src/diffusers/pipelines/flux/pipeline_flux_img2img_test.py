...
class FluxImg2ImgPipeline(DiffusionPipeline, FluxLoraLoaderMixin):
    ...
    def prepare_latents(
        ...
        print("shape: ", shape) # [2025-05-11T14:06:23.974605Z] 92b1c247 || shape:  (20, 16, 128, 128)
        # exit(0)
        ...
        if self.scheduler.__class__.__name__ != "FlowMatchEulerDiscreteScheduler":
            ...
            print("latents1: ", latents.shape)  # shape:  (20, 16, 128, 128)
            latents = self._pack_latents(latents, batch_size, num_channels_latents, height, width)
            print("latents2: ", latents.shape)  # torch.Size([20, 4096, 64])
            exit(0)
...
#             #     continue
                ...
                # [2025-05-11T14:04:34.840164Z] 703f7e04 || torch.Size([20, 4096, 64])
                # [2025-05-11T14:04:34.840191Z] 703f7e04 || torch.Size([20])
                # [2025-05-11T14:04:34.840197Z] 703f7e04 || torch.Size([20])
                # [2025-05-11T14:04:34.840203Z] 703f7e04 || torch.Size([512, 3])
                # [2025-05-11T14:04:34.840207Z] 703f7e04 || torch.Size([4096, 3])
