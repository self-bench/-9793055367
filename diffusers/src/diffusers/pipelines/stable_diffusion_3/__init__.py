...
try:
    ...
    _import_structure["pipeline_stable_diffusion_3_img2img_real"] = ["StableDiffusion3Img2ImgPipelineReal"]
...
if TYPE_CHECKING or DIFFUSERS_SLOW_IMPORT:
    try:
        ...
        from .pipeline_stable_diffusion_3_img2img_real import StableDiffusion3Img2ImgPipelineReal
else:
    import sys
