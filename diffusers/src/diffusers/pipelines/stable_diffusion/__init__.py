...
try:
    ...
    _import_structure["pipeline_stable_diffusion_img2img_test"] = ["StableDiffusionImg2ImgPipeline_test"]
    ...
    _import_structure["pipeline_stable_diffusion_img2img_org"] = ["StableDiffusionImg2ImgPipelineORG"]
try:
...
if TYPE_CHECKING or DIFFUSERS_SLOW_IMPORT:
    try:
        ...
        from .pipeline_stable_diffusion_img2img_test import StableDiffusionImg2ImgPipeline_test
        from .pipeline_stable_diffusion_img2img_org import StableDiffusionImg2ImgPipelineORG
