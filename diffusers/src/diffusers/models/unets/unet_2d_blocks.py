...
def get_down_block(
    ...
    if down_block_type == "DownBlock2D":
        ...
        # print("SimpleCrossAttnDownBlock2D") # no
        # exit(0)
        if cross_attention_dim is None:
...
def get_mid_block(
    ...
    if mid_block_type == "UNetMidBlock2DCrossAttn":
        ...
        # print("UNetMidBlock2DSimpleCrossAttn") # no
        # exit(0)
...
class UNetMidBlock2DCrossAttn(nn.Module):
    ...
    def forward(
        ...
        hidden_states = self.resnets[0](hidden_states, temb)
        for attn, resnet in zip(self.attentions, self.resnets[1:]):
            # print(cross_attention_kwargs) # everything None
    ...
    def forward(
        ...
        for i, (resnet, attn) in enumerate(blocks):
            ...
            if torch.is_grad_enabled() and self.gradient_checkpointing:
                ...
                # print(encoder_hidden_states.shape) # torch.Size([4, 320, 64, 64])
                # print(hidden_states.shape) # torch.Size([4, 320, 64, 64])
                # exit(0)
