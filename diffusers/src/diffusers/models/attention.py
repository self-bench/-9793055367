...
class BasicTransformerBlock(nn.Module):
    ...
    def forward(
        ...
        if self.attn2 is not None:
            ...
            # print(encoder_hidden_states.shape) # torch.Size([4, 77, 1024])
            # print(norm_hidden_states.shape) # torch.Size([4, 4096, 320]) 64x64
            # print(attn_output.shape) # torch.Size([4, 4096, 320]) 64x64
            # exit(0)
            # if encoder_hidden_states is not None:
