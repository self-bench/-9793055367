...
from dataset_zoo import get_images_dataset
...
def config():
    ...
    parser.add_argument("--output-dir", default="./outputs_images", type=str)
...
def main(args):
    ...
    dataset = get_images_dataset(args.dataset, image_preprocess=image_preprocess, download=False, version = args.version, cfg = args.cfg)
    ...
    # else:
    scores = model.get_image_scores_dataset(joint_loader)
