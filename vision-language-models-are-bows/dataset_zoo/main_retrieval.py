...
def main(args):
    ...
    dataset = get_dataset(args.dataset, image_preprocess=image_preprocess, text_perturb_fn=text_perturb_fn, image_perturb_fn=image_perturb_fn, download=False, version = args.version, cfg = args.cfg)
...
if __name__ == "__main__":
    args = config()
    if 'geneval' in args.dataset and args.cfg is None:
        raise ValueError('Please provide a config file for geneval dataset')
    main(args)